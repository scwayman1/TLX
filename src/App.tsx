...
function DomainPage({page,onAction}:{page:string;onAction:(m:string)=>void}) { const info:Record<string,{icon:any;desc:string;stats:string[]}>={
 ...
 const queues:Record<string,[string,string,string,string][]>={
  ...
  'Parts & inventory':[['Reorder','Hydraulic filter HF-320','Phoenix · 2 on hand','danger'],['Reserved','Brake assembly BA-14TL','WO-24091 · expedited','warning'],['Healthy','Engine oil 15W-40','All locations · 96% fill rate','success']],
