...
const cssEntries = [
  ...
  ['text-display','typography.display.fontSize'], ['weight-display','typography.display.fontWeight'], ['leading-display','typography.display.lineHeight'],
  ['text-heading-lg','typography.heading-lg.fontSize'], ['weight-heading-lg','typography.heading-lg.fontWeight'], ['leading-heading-lg','typography.heading-lg.lineHeight'],
  ...
  ['text-label','typography.label.fontSize'], ['weight-label','typography.label.fontWeight'], ['leading-label','typography.label.lineHeight'],
  ['text-numeric','typography.numeric.fontSize'], ['weight-numeric','typography.numeric.fontWeight'], ['leading-numeric','typography.numeric.lineHeight'],
